...
summary(Data$GDP)
summary(Data$lnGDP)
qplot(Data$life, geom="histogram", binwidth=5)
qplot(Data$GDP, geom="histogram", binwidth=6)
qplot(Data$lnGDP, geom="histogram", binwidth=0.5)
