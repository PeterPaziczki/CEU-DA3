...
The following entries have been dropped because of being marked as non-countries. After data cleaning we have `r Data[,.N]` countries to investigate.
...
The histogram of logGDP has a more symmetric distribution then the GDP variable. The spread is also big in this case.
...
The seven countries with highest GDP per capita the residuals are all negative, which is quite unexpected. 
